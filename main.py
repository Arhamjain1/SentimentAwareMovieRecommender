...
# Load the vectorizer (ensure it was fitted previously)
# Load the vectorizer (ensure it was fitted previously)
...
def rcmd(m):
    global data, similarity  # Declare data and similarity as global to use them in the function
    m = m.lower()
    if 'data' not in globals() or 'similarity' not in globals():
...
def recommend():
    ...
    try:
        ...
        return "Error fetching reviews. Please try again later."
